...
(
    ...
    `rmb_amount`    decimal(10, 0) NOT NULL DEFAULT '0' COMMENT '人民币账号金额',
    `dollar_amount` decimal(10, 0) NOT NULL DEFAULT '0' COMMENT '美元金额',
...
(
    ...
    `gmt_create`           datetime       NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
    `gmt_modified`         datetime       NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
    `rmb_freeze_amount`    decimal(10, 0) NOT NULL DEFAULT '0' COMMENT '人民币冻结金额',
    `dollar_freeze_amount` decimal(10, 0) NOT NULL DEFAULT '0' COMMENT '美元冻结金额',
    `user_id`              bigint unsigned NOT NULL COMMENT '用户id',
    PRIMARY KEY (`id`)
